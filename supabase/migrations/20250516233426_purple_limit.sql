/*
  # Beta Signups Table and Policies

  1. New Tables
    - `beta_signups` table for storing beta program applications
  ...
  2. Security
    - Enable RLS
    - Public insert policy for signup form
    - Authenticated read policy for users
